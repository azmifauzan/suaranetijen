    ...
    <div class="min-h-screen bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
        ...
        <header class="border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
            <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
                <Link href="/" class="flex items-center gap-2 font-bold text-lg text-emerald-600 dark:text-emerald-400">
                    <span>SuaraNetijen</span>
                </Link>
                <div class="flex items-center gap-4 text-sm">
                    <Link href="/" class="text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100">
                        Cari Entitas
                    </Link>
                </div>
            </div>
        ...
        <main class="mx-auto max-w-5xl px-4 py-8 sm:px-6">
            ...
            <!-- Entity Header Card -->
            <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-8">
                <div class="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-3">
                            <h1 class="text-2xl font-black tracking-tight text-neutral-900 dark:text-neutral-100 sm:text-3xl">
                                {{ entity.name }}
                            </h1>
                            <span
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-4 text-sm text-neutral-500 dark:text-neutral-400">
                            <div>
                                Kategori: <span class="font-medium text-neutral-700 dark:text-neutral-300">{{ entity.category.name }}</span>
                            </div>
                ...
                <div v-if="entity.aliases.length > 0" class="mt-6 border-t border-neutral-100 pt-4 dark:border-neutral-800">
                    <div class="text-xs font-medium uppercase tracking-wider text-neutral-400">
            ...
            <div class="mt-6 rounded-xl border border-dashed border-neutral-300 bg-neutral-100/50 p-6 text-center dark:border-neutral-700 dark:bg-neutral-900/40">
